...
char display_gover_once = 1;
char pause_flag = 0;
char display_intro_once = 1;
int introSeconds = 0;

// display logo intro for 1 and a half second
void display_intro(){
...
// display the current and high schore
void display_score(){
    if (score_once){
        char str[20];
...
// update the current and high score
